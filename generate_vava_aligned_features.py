...
# --- CONFIGURATION ---
EXP_FOLDER = '/vision/anishn/GTCC_CVPR2024/output/multi-task-setting/V2___VAVA_egoprocel'
...
OUTPUT_DIR = '/vision/anishn/GTCC_Data_Processed_1fps/egoprocel/vava_aligned_features/'

def initialize_model(device):
    """Initialize and load the trained VAVA model"""
    ...
    model, epoch, loss, _, _ = ckpt_restore_mprong(
        ckpt_path,
        num_heads=num_heads,
        dropout=False,  # VAVA doesn't use dropout layers
        device=device
    )
...
if __name__ == "__main__":
    logger.info("="*80)
    logger.info("VAVA Aligned Feature Extraction")
    logger.info("="*80)
