...
ALIGNED_FEAT_DIR = '/vision/anishn/GTCC_Data_Processed_4fps/egoprocel/aligned_features'
PROTAS_BASE = '/vision/anishn/ProTAS/data_4fps/'
OUTPUT_JSON = '/vision/anishn/GTCC_CVPR2024/gtcc_action_means_4fps.json'
SUBSETS = [
    'egoprocel_subset1_S', 
...
def main():
    print("="*80)
    print("GTCC ACTION-WISE GEODESIC MEAN CALCULATION")
    print("="*80)
