...
# --- CONFIGURATION ---
EXP_FOLDER = '/vision/anishn/GTCC_CVPR2024/output/multi-task-setting/V2___tcc_egoprocel'
...
OUTPUT_DIR = '/vision/anishn/GTCC_Data_Processed_1fps/egoprocel/tcc_aligned_features/'

def initialize_model(device):
    """Initialize and load the trained TCC model"""
    ...
    model, epoch, loss, _, _ = ckpt_restore_mprong(
        ckpt_path,
        num_heads=num_heads,
        dropout=False,  # TCC doesn't use dropout layers
        device=device
    )
...
if __name__ == "__main__":
    logger.info("="*80)
    logger.info("TCC Aligned Feature Extraction")
    logger.info("="*80)
