"""
Video-Level OGPE Evaluation for ProTAS Model (4 FPS Version)
...
OUTPUT_FOLDER = '/vision/anishn/GTCC_CVPR2024/output_4fps/multi-task-setting/protas_eval_egoprocel_video_level_4fps'
...
def main():
    logger.info("=" * 60)
    logger.info("Video-Level OGPE Evaluation for ProTAS (4 FPS)")
