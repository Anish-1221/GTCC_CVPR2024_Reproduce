...
ALIGNED_FEAT_DIR = '/vision/anishn/GTCC_Data_Processed_4fps/egoprocel/lav_aligned_features'
PROTAS_BASE = '/vision/anishn/ProTAS/data_4fps/'
OUTPUT_JSON = '/vision/anishn/GTCC_CVPR2024/lav_action_means_4fps.json'
SUBSETS = [
    'egoprocel_subset1_S',
...
def main():
    print("="*80)
    print("LAV ACTION-WISE GEODESIC MEAN CALCULATION")
    print("="*80)
    ...
    for file_idx, f_name in enumerate(tqdm(feat_files, desc="Calculating LAV Action Means")):
